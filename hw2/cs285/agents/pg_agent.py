...
class PGAgent(BaseAgent):
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        if self.nn_baseline:
            ...
            baselines = baselines_unnormalized * \
    ...
    def _discounted_return(self, rewards):
        ...
        discounted_sum = 0
        for i in range(T):
            discounted_sum += (rewards[i] * (self.gamma ** i))

        list_of_discounted_returns = [discounted_sum] * T
    ...
    def _discounted_cumsum(self, rewards):
        ...
        list_of_discounted_cumsums.append(rewards[-1])
        for i in reversed(range(T-1)):
            new_sum = list_of_discounted_cumsums[-1] * self.gamma + rewards[i]
            list_of_discounted_cumsums.insert(0, new_sum)
